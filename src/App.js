...
function App() {
  ...
  axios('https://api.spotify.com/v1/artists?ids=0RqtSIYZmd4fiBKVFqyIqD%2C3PhoLpVuITZKcymswpck5b%2C26dSoYclwsYLMAKD3tpOr4', {
          method: 'GET',
          headers: { 'Authorization' : 'Bearer ' + token }
        })
	...
	return (
		<div className="App">
            ...
            <Route path="/comingup" render={()=> <ComingNext nextArtists={nextArtists} />} />
